                    ...
                    <ul class="nav nav-item header-icons navbar-nav-right ms-auto">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="main-cart-list cart-scroll">
                                    <div class="d-flex border-bottom main-cart-item">
                                        <div>
                                            <a class="d-flex p-3"  href="product-details">
                                                <div class="drop-img cover-image" data-image-src="{{ asset('assets/img/ecommerce/05.jpg') }}">
                                                </div>
                                    ...
                                    <div class="d-flex border-bottom main-cart-item">
                                        <div>
                                            <a class="d-flex p-3"  href="product-details">
                                                <div class="drop-img cover-image" data-image-src="{{ asset('assets/img/ecommerce/02.jpg') }}">
                                                </div>
                                                <div class="ms-3 text-start">
                                    ...
                                    <div class="d-flex border-bottom main-cart-item">
                                        <div>
                                            <a class="d-flex p-3"  href="product-details">
                                                <div class="drop-img cover-image" data-image-src="{{ asset('assets/img/ecommerce/12.jpg') }}">
                                                </div>
                                                <div class="ms-3 text-start">
                                    ...
                                    <div class="d-flex border-bottom main-cart-item">
                                        <div>
                                            <a class="d-flex p-3"  href="product-details">
                                                <div class="drop-img cover-image" data-image-src="{{ asset('assets/img/ecommerce/06.jpg') }}">
                                                </div>
                                                <div class="ms-3 text-start">
                                    ...
                                    <div class="d-flex border-bottom main-cart-item">
                                        <div>
                                            <a class="d-flex p-3"  href="product-details">
                                                <div class="drop-img cover-image" data-image-src="{{ asset('assets/img/ecommerce/04.jpg') }}">
                                                </div>
                                                <div class="ms-3 text-start">
                                ...
                                <div class="dropdown-footer text-start">
                                    <a class="btn btn-primary btn-sm btn-w-md" href="check-out">Checkout</a>
                        ...
                        <li class="dropdown nav-item  main-header-message ">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="main-message-list chat-scroll">
                                    <a href="chat" class="dropdown-item d-flex border-bottom">
                                ...
                                <div class="text-center dropdown-footer">
                                    <a class="btn btn-primary btn-sm btn-block text-center"  href="chat">VIEW ALL</a>
                                </div>
                            </div>
                        </li>
                        <li class="dropdown nav-item main-header-notification d-flex">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="main-notification-list Notification-scroll">
                                    <a class="d-flex p-3 border-bottom" href="mail">
                                ...
                                <div class="dropdown-footer">
                                    <a class="btn btn-primary btn-sm btn-block" href="mail">VIEW ALL</a>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="chat"><i class="far fa-smile"></i> chat</a>
                                <a class="dropdown-item" href="mail-read"><i class="far fa-envelope "></i>Inbox</a>
                                <a class="dropdown-item" href="mail"><i class="far fa-comment-dots"></i>Messages</a>
                                <a class="dropdown-item" href="mail-settings"><i class="far fa-sun"></i>  Settings</a>
                                <a class="dropdown-item" href="signup"><i class="far fa-arrow-alt-circle-left"></i> Sign Out</a>
                            </div>
                        </li>
                    </ul>
                </div>
